# -*- coding: utf-8 -*-
"""
Created on Thu Nov 10 22:51:17 2022
...
myModel.compile(optimizer=SGD(lr=lr_schedule(0)), loss=categorical_crossentropy, metrics=['accuracy'])
...
hist = myModel.fit(X_train, Y_train, batch_size=128, epochs=epoch, validation_split=0.2)
